...
public class ExcluirDVD extends javax.swing.JFrame {
    ...
    public ExcluirDVD() {
     ...
     private void AtualizaCombo() {
        ...
        for (DVD b : lista) {
            combo.addItem(""+b.getCodigo()+" - ("+b.getCod_filme()+")");
        }
    ...
    private void btnCadastrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCadastrarActionPerformed
        ...
        if(cod.equals("")){
            ...
            int b = JOptionPane.showConfirmDialog(null, "Deseja Realmente Excluir \n"+nome+"?", "Video Locadora", JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE );
            
            
            if(b==0){
                int codigo = Integer.parseInt(cod);
                a.setCodigo(codigo);
                String res = sql.ExcluirDVD(a);
                
                
                if(!res.equals("Excluído com sucesso!")){
                     JOptionPane.showMessageDialog(null, "Este DVD está sendo Utilizado!", "Video Locadora", JOptionPane.ERROR_MESSAGE);
                }
    ...
    private void comboActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_comboActionPerformed
        String total = combo.getSelectedItem().toString();
        String [] n = total.split(" -");
        iptCod.setText(n[0]);
