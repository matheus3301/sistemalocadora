    ...
    private void btnCadastrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCadastrarActionPerformed
        ...
        if(cod.equals("")){
            ...
            if(b==0){
                ...
                a.setCodigo(codigo);
                String res = sql.ExcluirFilme(a);
                
                if(!res.equals("Excluído com sucesso!")){
                     JOptionPane.showMessageDialog(null, "Este filme está sendo Utilizado!", "Video Locadora", JOptionPane.ERROR_MESSAGE);
                }
